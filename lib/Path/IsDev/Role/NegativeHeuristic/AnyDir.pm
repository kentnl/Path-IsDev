...
package Path::IsDev::Role::NegativeHeuristic::AnyDir;
BEGIN {
  $Path::IsDev::Role::NegativeHeuristic::AnyDir::AUTHORITY = 'cpan:KENTNL';
}
{
  $Path::IsDev::Role::NegativeHeuristic::AnyDir::VERSION = '0.6.1';
}

# ABSTRACT: Negative Heuristic if a path contains one of any of a list of directories
...
sub _excludes_dirs {
  ...
  for my $file ( $self->excludes_dirs ) {
...
Path::IsDev::Role::NegativeHeuristic::AnyDir - Negative Heuristic if a path contains one of any of a list of directories
...
{
    "namespace":"Path::IsDev::Role::NegativeHeuristic::AnyDir",
    "interface":"role",
