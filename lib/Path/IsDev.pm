...
And it is this kind of problem that usually catches people off guard.
    ...
    ...
    [Path::IsDev=0] Path::IsDev::Heuristic::Tool::Dzil => 0 : dist.ini does not exist 
    [Path::IsDev=0] Path::IsDev::Heuristic::Tool::MakeMaker => 0 : Makefile.PL does not exist 
    [Path::IsDev=0] Path::IsDev::Heuristic::Tool::ModuleBuild => 0 : Build.PL does not exist 
    [Path::IsDev=0] Path::IsDev::Heuristic::META => 0 : META.json does not exist 
    [Path::IsDev=0] Path::IsDev::Heuristic::META => 1 : META.yml exists 
    [Path::IsDev=0] Path::IsDev::Heuristic::META => 1 : /home/kent/perl5/META.yml is a file 
...
No wonder!
    ...
    ...
    [Path::IsDev=0] Path::IsDev::Heuristic::TestDir => 0 : xt does not exist 
    [Path::IsDev=0] Path::IsDev::Heuristic::TestDir => 1 : t exists 
    [Path::IsDev=0] Path::IsDev::Heuristic::TestDir => 1 : /home/kent/perl5/t is a dir 
...
Or, you could use a negative heuristic.
    ...
    ...
    [Path::IsDev=0] Matching /home/kent/perl5
    [Path::IsDev=0] Path::IsDev::NegativeHeuristic::IsDev::IgnoreFile => 1 : .path_isdev_ignore exists 
    [Path::IsDev=0] Path::IsDev::NegativeHeuristic::IsDev::IgnoreFile => 1 : /home/kent/perl5/.path_isdev_ignore is a file 
    [Path::IsDev=0] Negative ::IsDev::IgnoreFile excludes path /home/kent/perl5
